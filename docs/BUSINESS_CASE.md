...
BUSINESS_CASE_SUMMARY:
  ...
  annual_tier_lever: "$149.99/yr LIVE (2-months-free equiv, ~17% off monthly); ~72% GM at typical usage; improves LTV / renewal-churn / upfront cash. Base case models 100% monthly (zero annual uptake), so NO ARR-timeline acceleration is booked to the annual tier specifically — the ~month-38 $100K crossing is driven by the $14.99 price, not annual; see Section 9"
...
**ARR effect (not a second timeline pull-forward)**: The ~Month 42 → ~Month 38 pull-forward of the
$100K ARR crossing is driven entirely by the $9.99 → $14.99 price move (§3 pricing note; § "Levers
ranked by impact" item 1) and is **not** re-counted here. Layered on that price-driven ~Month 38
base, a 30% annual mix instead improves *effective retention* and year-1 ARR (the ~+12% row above) —
a modest incremental upside treated as optionality, not booked into the base floor. Its primary,
defensible value is LTV / renewal-churn / upfront cash (see the LTV table and cash-flow benefit
above), not moving the same month-crossing a second time.
