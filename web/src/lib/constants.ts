...
export const MIN_CLIP_DURATION = 2; // seconds — parity with iOS minClipDuration
export const MAX_CLIP_DURATION = 60;
export const HIGHLIGHT_CONFIDENCE_THRESHOLD = 0.6; // parity with iOS highlightConfidenceThreshold
export const TARGET_CLIP_COUNT = 8; // offline fallback only — cloud path lets Opus decide
