...
|---|---|---|---|
| #96 | docs(F): annual tier lever analysis — $149.99/yr recommendation with full unit economics | F/business | pending #96 |
| #95 | test(G2): ios-plan route tests — quota gate, upstream error, success (6 tests) | G2 | pending #95 |
| #84 | feat(P0): rescue — import CLAUDE_VALIDATOR from ai-models; add ios-validate tests (6 tests) | P0/G2 | pending #84 |
...
- PR #84: P0 ios-validate backend + tests (rescue Run 17) — pending CI merge
- PR #88: security/P0 validate quota gate — pending CI merge
- PR #91: meta Run 16 housekeeping — pending CI merge
- PR #95: G2 ios-plan route tests — pending CI merge
- PR #96: F business case annual tier analysis — pending CI merge
